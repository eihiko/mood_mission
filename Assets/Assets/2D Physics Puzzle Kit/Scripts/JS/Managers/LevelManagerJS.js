...
public class LevelManagerJS extends MonoBehaviour 
{
    ...
    private var placedItem			: ObjectBaseJS;							//Holds every active item from the toolbox
	...
	function Update()
	{
		if (!inPlayMode && placedItem && !placedItem.GetValidPos())
		{
			ToolboxManagerJS.Instance().AddItem(placedItem);
    ...
    //
	public function RemovePlacedItem()
	{
		placedItem = null;
	}
